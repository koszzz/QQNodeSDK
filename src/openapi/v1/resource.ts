const apiMap = {
  ...
  groupMembersURI: '/v2/groups/:openID/members',
  groupMemberURI: '/v2/groups/:openID/members/:memberOpenID',
  groupBatchRemoveMembersURI: '/v2/groups/:openID/batch_remove_members',
  groupMemberBlacklistURI: '/v2/groups/:openID/member_blacklist',
